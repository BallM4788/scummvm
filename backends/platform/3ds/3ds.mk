...
#---------------------------------------------------------------------------------
# FILEPATH = backends/platform/3ds/[NAME].shbin
# FILE     = [NAME].shbin
# $(DEVKITPRO)/tools/bin/picasso -o backends/platform/3ds/[NAME].shbin [NAME].v.pica
# $(DEVKITPRO)/tools/bin/bin2s backends/platform/3ds/[NAME].shbin | $(AS) -o backends/platform/3ds/[NAME].shbin.o
# To a new line in backends/platform/3ds/[NAME].shbin.h, write "extern const u8 [NAME]_shbin_end[];"
# To a new line in backends/platform/3ds/[NAME].shbin.h, write "extern const u8 [NAME]_shbin[];"
# To a new line in backends/platform/3ds/[NAME].shbin.h, write "extern const u32 [NAME]_shbin_size;"
define shader-as
...
# engines/grim/gfx_n3ds.cpp includes shader header files generated by the shader assembler
engines/grim/gfx_n3ds.o: \
	engines/grim/shaders-3ds/grim_actor.shbin.o \
	engines/grim/shaders-3ds/grim_actorlights.shbin.o \
	engines/grim/shaders-3ds/emi_actor.shbin.o \
	engines/grim/shaders-3ds/emi_actorlights.shbin.o \
	engines/grim/shaders-3ds/grim_background.shbin.o \
	engines/grim/shaders-3ds/emi_background.shbin.o \
	engines/grim/shaders-3ds/emi_dimplane.shbin.o \
	engines/grim/shaders-3ds/emi_sprite.shbin.o \
	engines/grim/shaders-3ds/grim_dim.shbin.o \
	engines/grim/shaders-3ds/grim_emerg.shbin.o \
	engines/grim/shaders-3ds/grim_primRect.shbin.o \
	engines/grim/shaders-3ds/grim_primLines.shbin.o \
	engines/grim/shaders-3ds/grim_shadowplane.shbin.o \
	engines/grim/shaders-3ds/grim_smush.shbin.o \
	engines/grim/shaders-3ds/grim_text.shbin.o \
	engines/grim/shaders-3ds/manualclear.shbin.o