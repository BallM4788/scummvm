...
clean_3ds:
	$(RM) $(SHADER_GENFILES)
	$(RM_REC) engines/playground3d/shaders-3ds/$(DEPDIR)
	$(RM) $(TARGET).smdh
	$(RM) $(TARGET).3dsx
	$(RM) $(TARGET).bnr
	$(RM) $(TARGET).cia
...
INCLUDED_SHADERS := \
	backends/platform/3ds/shader.shbin.o
ifdef ENABLE_PLAYGROUND3D
INCLUDED_SHADERS += \
	backends/platform/3ds/shaders/playground3d/playground3d_cube.shbin.o \
	backends/platform/3ds/shaders/playground3d/playground3d_offset.shbin.o \
	backends/platform/3ds/shaders/playground3d/playground3d_fade.shbin.o
endif

# osystem-graphics.cpp includes shader_shbin.h that is generated by the shader assembler
backends/platform/3ds/osystem-graphics.o: $(INCLUDED_SHADERS)
