...
define shader-as
	...
	$(DEVKITPRO)/tools/bin/bin2s -a 4 -H `(echo $(FILEPATH) | sed 's/\(.*\)\./\1_/')`.h $(FILEPATH) | \
	$(CC) -x assembler-with-cpp $(CPPFLAGS) -g -march=armv6k -mtune=mpcore -mfloat-abi=hard -mtp=soft -c - -o $(FILEPATH).o
endef
