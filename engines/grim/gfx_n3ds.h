...
private:
	N3DS_3D::ContextHandle *_backendContext, *_grimContext;

	const Actor *_currentActor;
	Math::Vector4d _color;					// DEFINITE? - ADDED
	float _alpha;
	int _maxLights;
	C3D_Tex _emergTexture;
	N3DS_3D::ShaderObj *_emergShader;

	N3DS_3D::ShaderObj *_backgroundShader;
	N3DS_3D::ShaderObj *_actorShader;
	N3DS_3D::ShaderObj *_actorLightsShader;
	N3DS_3D::ShaderObj *_spriteShader;
	N3DS_3D::ShaderObj *_dimShader;
	N3DS_3D::ShaderObj *_dimPlaneShader;
	N3DS_3D::ShaderObj *_dimRegionShader;
	N3DS_3D::ShaderObj *_smushShader;
	void *_blankVBO, *_smushVBO, *_quadEBO;
	N3DS_3D::ShaderObj *_textShader;
	N3DS_3D::ShaderObj *_primRectShader;
	N3DS_3D::ShaderObj *_primLinesShader;
	N3DS_3D::ShaderObj *_irisShader;
	N3DS_3D::ShaderObj *_shadowPlaneShader;
	N3DS_3D::ShaderObj *_manualClearShader;

	int _smushWidth;
	int _smushHeight;
	C3D_Tex _smushTex;
	void setupUntexturedQuad();
...
//	Math::Vector2d _zBufTexCrop;					// (WE DON'T NEED THIS)
	...
	void *nextPrimitive();
	void *_primitiveVBOs[32];
	void *_primVBOChunk;
	uint32 _lastPrimitive;
	...
	void    *_dimRegionVBO;
	void    *_blastVBO;
	C3D_Tex  _storedDisplay;

//	ADDED THINGS --- ADDED THINGS --- ADDED THINGS --- ADDED THINGS --- ADDED THINGS --- ADDED THINGS --- ADDED THINGS --- ADDED THINGS
