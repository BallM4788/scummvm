...
#ifndef GRIM_GFX_N3DS_H
#define GRIM_GFX_N3DS_H
...
public:
	...
	void makeScreenTextures() override;																					// DEFINITE? - ADDED
...
//	N3DS_3D::N3DContext _3dsRendCtxt;																					// DEFINITE? - ADDED
	...
	Math::Vector4d _color;																								// DEFINITE? - ADDED
	float _alpha;
	int _maxLights;
...
//	OpenGL::Shader* _shadowPlaneProgram;
	...
	N3DS_3D::ShaderObj *_programActor;																					// DEFINITE?
	N3DS_3D::ShaderObj *_programActorLights;																			// DEFINITE?
	N3DS_3D::ShaderObj *_programSprite;																					// DEFINITE?
	N3DS_3D::ShaderObj *_programDim;																					// DEFINITE?
	N3DS_3D::ShaderObj *_programDimPlane;																				// DEFINITE?
	N3DS_3D::ShaderObj *_programDimRegion;																				// DEFINITE?
	N3DS_3D::ShaderObj *_programSmush;																					// DEFINITE?
	void               *_blankVBO, *_smushVBO, *_quadEBO;																// DEFINITE? - PARTIAL ADD
	N3DS_3D::ShaderObj *_programText;																					// DEFINITE?
	N3DS_3D::ShaderObj *_programPrimRect;																				// DEFINITE? - REIMPLEMENTED
	N3DS_3D::ShaderObj *_programPrimLines;																				// DEFINITE? - REIMPLEMENTED
	N3DS_3D::ShaderObj *_programIris;																					// DEFINITE?
	N3DS_3D::ShaderObj *_programShadowPlane;																			// DEFINITE?
	N3DS_3D::ShaderObj *_programClear;																					// DEFINITE? - ADDED
...
//	GLuint _spriteVBO;
	void *_spriteVBO;																									// DEFINITE?

	Common::Stack<Math::Matrix4> _matrixStack;
	Texture *_selectedTexture; // GRIM class, NOT OpenGL backend subclass of Graphics::Surface

//	GLuint _zBufTex;
//	Math::Vector2d _zBufTexCrop;																						// (WE DON'T NEED THIS)
	void *_zBuf;																										// DEFINITE?

//	struct GLSLight {
	struct LightObj {																									// FINALIZED
...
//	GLuint _primitiveVBOs[32];
	void *nextPrimitive();																								// DEFINITE?
	void *_primitiveVBOs[32];																							// DEFINITE?
	void *_primVBOChunk;																								// DEFINITE? - ADDED
	uint32 _lastPrimitive;																								// DEFINITE? - ADDED
