...
void N3DSRenderer::loadTextureRGBA(Graphics::Surface *texture) {
	...
	custom3DS_DataToBlockTex((u32 *)tmp, (u32 *)_textureRgba.data, 0, 0, wPow2, hPow2, wPow2, hPow2, GPU_RGBA8);
...
void N3DSRenderer::loadTextureRGB(Graphics::Surface *texture) {
	...
	//	little endian order (as required for the RGBA8 format for 3DS textures)
	//	before swizzling. Input pixels are assumed to be big endian.
	custom3DS_DataToBlockTex((u32 *)tmp, (u32 *)_textureRgb.data, 0, 0, wPow2, hPow2, wPow2, hPow2, GPU_RGBA8);
...
void N3DSRenderer::loadTextureRGB565(Graphics::Surface *texture) {
	...
	//	little endian order (as required for the RGBA8 format for 3DS textures)
	//	before swizzling. Input pixels are assumed to be big endian.
	custom3DS_DataToBlockTex((u32 *)tmp, (u32 *)_textureRgb565.data, 0, 0, wPow2, hPow2, wPow2, hPow2, GPU_RGBA8);
...
void N3DSRenderer::loadTextureRGBA5551(Graphics::Surface *texture) {
	...
	//	custom3DS_C3D_SyncDisplayTransfer instead of custom3DS_DataToBlockTex.
	...
	// Convert pixels to little endian RGBA8, as custom3DS_C3D_SyncDisplayTransfer
	...
	// Swizzle temporary buffer into C3D_Tex
	// custom3DS_C3D_SyncDisplayTransfer will also swizzle data (and also unswizzle it).
